#ifdef VERSION_CN
/* iQue compiles this file with EGCS -O2 (body via sm64's matched cn libultra) */
...
static const du P[5] = {
    { 1.0 }, { -0.16666659550427756 }, { 0.008333066246082155 }, { -1.980960290193795E-4 }, { 2.605780637968037E-6 }
};
