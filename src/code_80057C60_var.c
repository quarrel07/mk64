...
/* jp.v10: the launch build compiled this and code_80057C60.c as one
   translation unit; these continue that file's tail in cart order.
   The TU split keeps each side under IDO's 253-variable bss table,
   which is also why the split exists upstream at all. */
s16 D_8018CFB8;
u8 D_8018CFAC[4];
s16 D_8018CFC0;
u8 D_8018CFB4[4];
...
f32 D_8018D00C;
s16 D_8018D020;
UNUSED s16 pad_8018AA2A;
UNUSED s32 pad_8018AA2C;
s16 D_8018D048;
f32 xOrientation;
s16 D_8018D070;
UNUSED s16 pad_8018AA3A;
UNUSED s32 pad_8018AA3C;
f32 D_8018D028[8];
s16 D_8018D098;
f32 D_8018D050[8];
s16 D_8018D0C0;
...
s16 D_8018D110;
f32 D_8018D0C8[8];
UNUSED s16 pad_8018AB00;
f32 D_8018D0F0[8];
UNUSED s16 pad_8018AB28;
UNUSED s16 pad_8018AB2A;
UNUSED s32 pad_8018AB2C;
s32 D_8018D114;
UNUSED s32 D_8018D118[2];
s32 gMatrixHudCount;
UNUSED s32 D_8018D128[4];
s32 D_8018D140;
UNUSED s32 D_8018D148;
s32 D_8018D150;
...
s16 D_8018D18C;
s32 D_8018D180;
UNUSED s32 pad_8018AB94;
s8 D_8018D198[NUM_GROUP1_MOLES];
s32 gIsHUDVisible;
UNUSED s32 pad_8018ABA4;
...
s8 D_8018D230;
s32 D_8018D224;
UNUSED s32 pad_8018AC38;
s32 D_8018D22C;
s32 D_8018D240;
UNUSED s32 pad_8018AC44;
u8* D_8018D248[22];
f32 gMiniMapMarkerScale;
UNUSED s32 D_8018D2A8;
UNUSED s32 pad_8018ACA8[2];
s16 D_8018D2B0;
s32 D_8018D2A4;
s16 D_8018D2B8;
s32 D_8018D2AC;
s16 gMiniMapFinishLineX[2];
s32 D_8018D2B4;
s16 gMiniMapFinishLineY[2];
s32 D_8018D2BC;
s16 gMiniMapX;
...
u16 D_8018D310;
UNUSED s32 pad_8018AD14;
u16 D_8018D318;
UNUSED s32 pad_8018AD1C;
s32 D_8018D314;
UNUSED s32 pad_8018AD24;
s32 D_8018D320;
