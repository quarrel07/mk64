...
#ifdef VERSION_JP
/* JP puts sIntroModelTimer at the head of this file's bss instead of next to
   D_8018ED91, which is what moves func_800A66A8's statics down to 0x8018b55c. */
s32 sIntroModelTimer;
s32 menu_item_bss_padjp0;
#endif
...
Unk_D_800E70A0 D_800E7360[] = {
    { 0x75, 0xa7, 0x00, 0x00 }, { 0x75, 0xb6, 0x00, 0x00 }, { 0x75, 0xc5, 0x00, 0x00 }, { 0x75, 0xd4, 0x00, 0x00 },
};
#else
Unk_D_800E70A0 D_800E7360[] = {
    { 0x61, 0xa7, 0x00, 0x00 },
...
Unk_D_800E70A0 D_800E7390[] = {
    { 0xb4, 0x8e, 0x00, 0x00 }, { 0xb4, 0x9b, 0x00, 0x00 }, { 0xb4, 0xa8, 0x00, 0x00 },
    { 0xb4, 0xb5, 0x00, 0x00 }, { 0xb4, 0xc2, 0x00, 0x00 }, { 0xb4, 0xcf, 0x00, 0x00 },
};
#else
Unk_D_800E70A0 D_800E7390[] = {
...
Unk_D_800E70A0 D_800E73E0[] = {
    { 0x6c, 0x94, 0x00, 0x00 }, { 0x6c, 0xa1, 0x00, 0x00 }, { 0x6c, 0xae, 0x00, 0x00 }, { 0x6c, 0xbb, 0x00, 0x00 },

    { 0x6c, 0xc8, 0x00, 0x00 }, { 0x6c, 0xd5, 0x00, 0x00 },
};
#else
Unk_D_800E70A0 D_800E73E0[] = {
...
const s16 gGlyphDisplayWidth[] = {
...
#ifdef VERSION_JP
    0x000c, 0x000c, 0x000c, 0x000c, 0x000b, 0x000d, 0x000c, 0x000c, 0x0012, 0x000c, 0x000c, 0x000c, 0x000a, 0x000a,
#else
    ...
    0x0008, 0x001c, 0x000a, 0x0010,
#ifdef VERSION_CN
    // The Chinese font is fixed pitch from here on and covers a hundred more
    // glyphs than the Latin one: 290 entries of 20 where the table below runs
    // 190 varied entries and stops.
...
#else
    0x000f, 0x0010, 0x000f, 0x000f, 0x000f, 0x000f, 0x000f, 0x000f, 0x000f, 0x000f,
...
#ifdef VERSION_CN
char* gCupNames[] = {
    "\xa1\xa1\xa1\x57\xa1\x1e",
    "\xa1\xed\xa1\x65\xa1\x1e",
    "\xa1\xef\xa1\xef\xa1\x1e",
    "\xa1\xcb\xa2\x01\xa1\x1e",
    "\xa1\x47\xa2\x0b",
    "\xa1\xa1\xa1\x57\xa1\x1e",
    "\xa1\xed\xa1\x65\xa1\x1e",
    "\xa1\xef\xa1\xef\xa1\x1e",
...
#ifdef VERSION_CN
char* gCourseNames[] = {
    "\xa1\x99\xa1\x90\xa1\xac\xa1\xc1\xa1\x3d",
    "\xa1\xb5\xa1\x85\xa1\x90\xa1\xc6",
    "\xa1\x88\xa1\x18\xa1\xe3\xa1\x2d\xa1\x1c",
    "\xa2\x00\xa1\x95\xa1\x64",
    "\xa1\xf4\xa1\xe8\xa1\x58",
    "\xa1\x22\xa1\xde\xa1\xf2\xa1\x40",
    "\xa2\x18\xa1\x89\xa2\x18\xa1\x89\xa1\x5a\xa1\xda",
    "\xa1\xdb\xa1\x65\xa1\x54\xa2\x12\xa1\xc1\xa1\x3d",
    "\xa1\x97\xa1\xf9\xa1\x6c\xa1\xc1\xa1\x3d",
    "\xa2\x17\xa2\x17\xa1\xa5\xa1\x2a",
    "\xa1\xb0\xa1\xab\xa1\x20\xa1\x16\xa1\x54\xa1\x97",
    "\xa1\x4f\xa1\x5b\xa1\xc5\xa1\xa4",
    "\xa1\x22\xa1\x92\xa1\x40\xa1\x3a",
    "\xa1\x25\xa1\x61\xa1\xb4",
    "\xa1\xe1\xa1\x90\xa1\xac\xa1\x7d\xa1\x6d\xa1\x2a",
    "\xa1\xd6\xa1\xc3\xa1\x1c\xa1\x8d",
    "\xa1\xa3\xa1\xde\xa1\x39\xa1\x96",
    "\xa1\x71\xa1\x28\xa1\xd1\xa1\x7a",
    "\xa1\xc4\xa1\xe9\xa1\x50\xa1\x36\xa1\x94\xa1\x54\xa2\x06",
    "\xa1\x39\xa1\x9e\xa1\x1a\xa1\xba",
};
#else
char* gCourseNames[] = {
#ifdef VERSION_JP
#include "assets/course_metadata/gCourseNames.jp1.inc.c"
#else
...
char* gCourseNamesDup[] = {
#ifdef VERSION_JP
#include "assets/course_metadata/gCourseNames.jp2.inc.c"
#else
#include "assets/course_metadata/gCourseNames.inc.c"
#endif
};
...
char* gCourseNamesDup2[] = {
#ifdef VERSION_JP
#include "assets/course_metadata/gCourseNames.jp3.inc.c"
#else
#include "assets/course_metadata/gCourseNames.inc.c"
#endif
};
...
char* gDebugCharacterNames[] = {
    "\xa1\x99\xa1\x90\xa1\xac",
    "\xa1\x97\xa1\xf9\xa1\x6c",
    "\xa1\xf4\xa1\xe8",
    "\xa1\xb0\xa1\xab\xa1\x20\xa1\x16",
    "\xa1\xc4\xa1\xe9\xa1\x50",
    "\xa1\xe1\xa1\x90\xa1\xac",
    "\xa1\xdb\xa1\x65\xa1\x54\xa2\x12",
    "\xa1\x88\xa1\x18\xa1\xe3",
};
#else
char* gDebugCharacterNames[] = {
...
char* D_800E76A8[] = {
    ...
    "\xa1\xdb\xa1\x65\xa1\x54\xa2\x12",
    "\xa1\x88\xa1\x18\xa1\xe3",
    "\xa1\x02\xa1\x02\xa1\x02\xa1\x02",
};
#else
char* D_800E76A8[] = {
#ifdef VERSION_JP
    "マリオ",   "ルイージ", "ヨッシー", "キノピオ", "Ｄ．コング", "ワリオ", "ピーチ", "クッパ",
#else
...
char* D_800E76CC[] = {
    "\x35\x30\x20\x43\x43",
    "\x31\x30\x30\x20\x43\x43",
    "\x31\x35\x30\x20\x43\x43",
    "\xa1\xdc\xa1\x21\xa1\xc1",
};
...
char* gDebugScreenModeNames[] = {
    "\xa1\x3b\xa1\xbe",
    "\xa1\x49\xa1\xbe\xa1\xc8\xa1\xec\xa1\x4d\xa1\xaf",
    "\xa1\x49\xa1\xbe\xa2\x16\xa2\x03\xa1\x4d\xa1\xaf",
    "\xa1\xc2\xa1\xbe",
    "\xa1\xd6\xa1\xbe",
};
#else
...
char* gDebugSoundModeNames[] = {
    "\xa1\x8f\xa1\xdd\xa1\xcc",
    "\xa1\x48\xa1\x69",
    "\xa1\x15\xa1\x15\xa1\x15",
    "\xa1\x3b\xa1\xcc\xa1\x3d",
};
#else
char* gDebugSoundModeNames[] = {
    "stereo",
...
#else
#ifdef VERSION_JP
char* gSoundModeNames[NUM_SOUND_MODES] = { "ステレオ", "ヘッドホン", "", "モノラル" };
#else
...
#ifdef VERSION_CN
char* gWinLoseText[] = {
    "\xa1\xcd\xa1\x8e\xa1\x04",
    "\xa1\xce\xa1\x19\xa1\x04",
};
#else
#ifdef VERSION_JP
char* gWinLoseText[] = {
...
char* gPrefixTimeText[] = {
    "\xa1\x41\xa1\xf5\xa1\xba",
    "\xa1\x41\xa1\x49\xa1\xba",
    "\xa1\x41\xa1\xc2\xa1\xba",
    "\xa1\xbb\xa1\x2f",
};
#else
#ifdef VERSION_JP
...
#ifdef VERSION_CN
char* D_800E7744[] = {
    "\xa1\x41\xa1\xf5\xa1\xa0",
    "\xa1\x41\xa1\x49\xa1\xa0",
    "\xa1\x41\xa1\xc2\xa1\xa0",
    "\xa1\x41\xa1\xd6\xa1\xa0",
    "\xa1\x41\xa1\xe7\xa1\xa0",
    "\xa1\x03",
};
#else
char* D_800E7744[] = {
...
char* gTextPauseButton[] = {
    "\xa1\x6f\xa1\xf0\xa2\x01\xa1\xea",
    "\xa2\x11\xa1\xd2",
    "\xa1\x53\xa1\x66\xa1\xc1\xa1\x3d",
    "\xa1\x53\xa1\x66\xa1\xc1\xa1\xd3",
    "\xa1\xe0\xa1\x30",
    "\xa1\x67\xa1\x4c",
    "\xa1\x1b\xa1\x37\xa1\x2c\xa1\xfd",
};
#else
#ifdef VERSION_JP
char* gTextPauseButton[] = {
    "ゲームをつづける", "リトライ", "コースチェンジ", "ドライバーチェンジ", "ゲームをやめる", "リプレイ", "ゴーストのセーブ",
};
#else
char* gTextPauseButton[] = {
...
#ifdef VERSION_CN
char* D_800E7778[] = {
    "\xa1\x7d\xa1\xd7\xa1\xa2\xa1\xd0\xa1\xad\xa1\xa0",
    "\xa1\x47\xa2\x0b\xa1\xa2\xa1\xd0\xa1\xad\xa1\xa0",
};
#else
#ifdef VERSION_JP
char* D_800E7778[] = {
...
#ifdef VERSION_CN
char gTextMenuAnnounceGhost[] = "\xa1\xa9\xa1\xae\xa1\x3c\xa1\xc1\xa1\x3d\xa1\x2c\xa1\xfd\xa1\x8b\xa1\x04";
#else
#ifdef VERSION_JP
char gTextMenuAnnounceGhost[] = "CHALLENGER COMES!!!";
#else
...
char* gTextNoController[] = {
    "\xa1\x78\xa1\xd3\xa1\x23\xa2\x04\xa1\xf5\xa1\x5d\xa1\x79\xa1\x87\xa1\x91\xa1\x79",
    "\xa1\xbd\xa1\x63\xa1\x83\xa1\xb1\xa1\x42\xa2\x07",
};
#else
#ifdef VERSION_JP
char* gTextNoController[] = { "1P のコントローラをせつぞくして", "でんげんをいれなおしてください" };
#else
...
char* gTextBattleIntroduction[] = {
    "\xa1\x47\xa2\x0b\xa1\xa2\xa1\xd0",
    "\xa1\x38\xa1\x1d\xa1\x47\xa1\xd3\xa1\x3f\xa1\xb2\xa1\xb7",
    "\xa1\xc2\xa1\x52\xa1\x45\xa1\x38\xa1\x1d\xa1\x63\xa1\x06\xa1\xd9\xa1\x9c\xa1\x7f\xa1\x30\xa1\x80\xa1\x93\xa1\x04",
};
#else
#ifdef VERSION_JP
char* gTextBattleIntroduction[] = {
...
// This is plain data, it should not end up in rodata
#ifdef VERSION_CN
char gTextMenuData[] = "\xa1\x13\xa1\x75\xa1\x29\xa1\x84\xa1\xd4\xa1\x81\xa1\x03\xa1\x14\xa1\x75\xa1\xe0\xa1\x30";
#else
#ifdef VERSION_JP
char gTextMenuData[] = "a ボタン*データをみる  B ボタン*もどる";
#else
...
// This is plain data, it should not end up in rodata
#ifdef VERSION_CN
char gTextDistance[] = "\xa1\x2b";
#else
#ifdef VERSION_JP
char gTextDistance[] = "ぜんちょう";
#else
...
#ifdef VERSION_CN
char* sCourseLengths[] = {
    "\xa1\x0d\xa1\x0e\xa1\x0f\xa1\x9d",
    "\xa1\x0e\xa1\x10\xa1\x0f\xa1\x9d",
    "\xa1\x0f\xa1\x0f\xa1\x0f\xa1\x9d",
    "\xa1\x0f\xa1\x0c\xa1\x0f\xa1\x9d",
    "\xa1\x0f\xa1\x0f\xa1\x0a\xa1\x9d",
    "\xa1\x0f\xa1\x0b\xa1\x0c\xa1\x9d",
    "\xa1\x0e\xa1\x11\xa1\x09\xa1\x9d",
    "\xa1\x09\xa1\x08\xa1\x0a\xa1\x0d\xa1\x9d",
    "\xa1\x0f\xa1\x09\xa1\x0f\xa1\x9d",
    "\xa1\x0d\xa1\x0a\xa1\x0f\xa1\x9d",
    "\xa1\x09\xa1\x08\xa1\x0b\xa1\x0e\xa1\x9d",
    "\xa1\x0f\xa1\x0d\xa1\x0b\xa1\x9d",
    "\xa1\x0f\xa1\x0d\xa1\x0e\xa1\x9d",
    "\xa1\x0a\xa1\x08\xa1\x08\xa1\x08\xa1\x9d",
    "\xa1\x09\xa1\x0d\xa1\x11\xa1\x09\xa1\x9d",
    "",
    "",
    "",
    "\xa1\x10\xa1\x11\xa1\x0b\xa1\x9d",
    "",
};
#else
char* sCourseLengths[] = {
...
char* gTextMenuOption[] = {
    "\xa1\x4b\xa1\x67",
    "\xa1\xc7\xa1\x31\xa1\x70\xa1\x98",
    "\xa1\xc7\xa1\x31\xa1\x2c\xa1\xfd",
};
#else
#ifdef VERSION_JP
char* gTextMenuOption[] = {
...
char* gEraseBestGhostText[] = {
    "\xa1\xc7\xa1\x31\xa1\x33\xa1\xc1\xa1\x3d\xa1\x3f\xa2\x15\xa1\x72",
    "\xa1\x2e\xa1\x6b\xa1\x5e\xa2\x15\xa1\x8a\xa1\x3b\xa1\xba\xa1\x2e\xa1\x6b\xa1\x00",
    "\xa1\xbc\xa1\x44\xa1\x9a\xa1\x12",
    "\xa1\xc7\xa1\x31\xa1\x33\xa1\xc1\xa1\x3d\xa1\x3f",
    "\xa1\x2c\xa1\xfd\xa1\x00",
    "\xa1\xbc\xa1\x44\xa1\x9a\xa1\x12",
};
#else
#ifdef VERSION_JP
...
#ifdef VERSION_CN
char* D_800E7860[] = {
    "\xa1\xe6\xa1\x4a\xa1\xc7\xa1\x31\xa1\x03",
    "\xa1\x2c\xa1\xfd",
};
#else
#ifdef VERSION_JP
...
char* gTextOptionMenu[] = {
    "\xa1\x4b\xa1\x67\xa1\x3c\xa1\xf1\xa2\x0a\xa2\x01\xa1\xea",
    "\xa1\xcc\xa1\xfb\xa1\xa2\xa1\xd0",
    "\xa1\x4e\xa2\x0f\xa1\x6e\xa1\xfa\xa1\xb8",
    "\xa1\xc7\xa1\x31\xa1\xd8\xa2\x02\xa1\xd4\xa1\x81",
};
#else
#ifdef VERSION_JP
char* gTextOptionMenu[] = {
...
#ifdef VERSION_CN
char* D_800E7878[] = {
    "\xa1\xd8\xa2\x02\xa1\xd4\xa1\x81\xa1\x78\xa1\x1f",
    "\xa1\xfe\xa1\x7e\xa1\xc7\xa1\x31\xa1\x00",
    "\xa1\xa9\xa1\xbc\xa1\x44\xa1\x9a\xa1\x12",
};
#else
#ifdef VERSION_JP
char* D_800E7878[] = {
...
char* D_800E7884[] = {
    "",
    "\xa1\xd8\xa2\x02\xa1\xd4\xa1\x81",
    "\xa1\xf7\xa1\x1f\xa1\xc7\xa1\x31\xa1\x00",
};
#else
#ifdef VERSION_JP
char* D_800E7884[] = {
...
#ifdef VERSION_CN
char* D_800E7890[] = {
    "\xa1\xa9\xa1\x9b\xa2\x02\xa1\xe4\xa1\xcb\xa2\x01\xa1\x69\xa1\xca\xa2\x0e",
    "\xa1\x6e\xa1\xfa\xa1\xb8",
    "",
    "",
    "\xa1\xe6\xa1\x4a\xa1\x35\xa1\xcb\xa2\x01\xa1\x69\xa1\x3f",
    "\xa1\x6e\xa1\xfa\xa1\xb8\xa1\x46\xa1\xb9\xa1\x03",
    "\xa2\x01\xa1\xea\xa1\xd4\xa1\x81",
    "",
    "\xa1\xe6\xa1\x4a\xa2\x09\xa1\xcb\xa2\x01\xa1\x69\xa1\x6e\xa1\xfa\xa1\xb8\xa1\xa7",
    "\xa1\x32\xa1\x77",
    "\xa2\x01\xa1\xea\xa1\xd4\xa1\x81",
    "",
    "\xa1\xe6\xa1\x4a\xa1\x4e\xa2\x0f\xa1\x2c\xa1\xfd",
    "\xa1\x07\xa1\x07\xa1\x03\xa2\x09\xa1\xcb\xa2\x01\xa1\x69\xa1\x6e\xa1\xfa\xa1\xb8\xa1\xa7",
    "\xa1\xe6\xa2\x14\xa1\x56\xa1\x3f",
    "\xa1\x86\xa1\x73",
};
#else
#ifdef VERSION_JP
...
#ifdef VERSION_CN
char* D_800E78D0[] = {
    "\xa2\x09\xa1\x55\xa2\x01\xa1\x69\xa1\x3f\xa1\x03",
    "\xa1\x6e\xa1\xfa\xa1\xb8\xa1\xa7\xa1\x03",
    "\xa1\x9b\xa2\x02\xa1\x2c\xa1\xfd",
    "\xa2\x09\xa1\x55\xa2\x01\xa1\x69\xa1\x3f\xa1\x6e\xa1\xfa\xa1\xb8\xa1\xa7\xa1\x03",
    "\xa1\x9b\xa2\x02\xa1\x99\xa1\x90\xa1\xac\xa1\x82\xa1\x43\xa1\x2c\xa1\x03",
    "\xa1\x3f\xa1\xd4\xa1\x81",
    "\xa1\xa9\xa1\x9b\xa2\x02\xa1\xe4\xa1\x03",
    "\xa1\x55\xa2\x01\xa1\x69\xa1\xca\xa2\x0e",
    "\xa1\x6e\xa1\xfa\xa1\xb8",
    "\xa1\xe6\xa1\x4a\xa1\x35\xa1\x55\xa2\x01\xa1\x69\xa1\x3f\xa1\x03",
    "\xa1\x6e\xa1\xfa\xa1\xb8\xa1\xa7\xa1\x46\xa1\xb9\xa1\x03",
    "\xa1\xd4\xa1\x81",
};
#else
#ifdef VERSION_JP
...
#ifdef VERSION_CN
char* D_800E7900[] = {
    "\xa1\xe6\xa1\x4a\xa1\x35",
    "\xa1\xcb\xa2\x01\xa1\x69\xa1\x3f\xa1\x6e\xa1\xfa\xa1\xb8",
    "\xa1\x4e\xa2\x0f\xa1\xd4\xa1\x81",
    "\xa1\xe6\xa1\x4a\xa1\x35\xa1\x55\xa2\x01\xa1\x69\xa1\x3f\xa1\x03",
    "\xa1\x6e\xa1\xfa\xa1\xb8\xa1\xa7\xa1\x03",
    "\xa1\x46\xa1\xb9\xa1\xd4\xa1\x81",
};
#else
#ifdef VERSION_JP
char* D_800E7900[] = {
...
#ifdef VERSION_CN
char* D_800E7918[] = {
    "\xa1\xcb\xa2\x01\xa1\x69",
    "\xa1\x55\xa2\x01\xa1\x69",
};
#else
#ifdef VERSION_JP
char* D_800E7918[] = {
...
#ifdef VERSION_CN
char* D_800E7920[] = {
    "\xa1\xa9\xa1\xf3\xa1\x4e\xa2\x0f\xa1\xa6\xa1\x52\xa1\xe5\xa1\x76\xa1\x12",
    "\xa1\x4e\xa2\x0f\xa1\x3c\xa1\xa6\xa1\x52\xa1\xe5\xa1\x76\xa1\x12",
};
#else
#ifdef VERSION_JP
char* D_800E7920[] = {
...
#ifdef VERSION_CN
char* D_800E7928[] = {
    "\xa2\x05\xa2\x02\xa1\x3f\xa1\xd4\xa1\x81\xa1\x78\xa1\x1f\xa1\xc7\xa1\x31\xa1\x06",
    "\xa1\xbc\xa1\x44\xa1\x9a\xa1\x12",
};
#else
#ifdef VERSION_JP
...
#ifdef VERSION_CN
char* D_800E7940[] = {
    "\xa1\x9b\xa2\x02\xa1\xca\xa2\x0e\xa1\x6e\xa1\xfa\xa1\xb8\xa1\x00",
    "\xa1\xbf\xa1\x59\xa1\xa9\xa1\xf3\xa1\x1b\xa1\x37\xa1\x2c\xa1\xfd\xa1\x06",
    "\xa1\xb6\xa2\x09\xa1\x7c\xa1\xc0\xa2\x01\xa1\xea\xa1\xb3\xa1\x06",
    "\xa1\xe4\xa1\xcb\xa2\x01\xa1\x69\xa1\xca\xa2\x0e\xa1\x6e\xa1\xfa\xa1\xb8\xa1\x00",
    "\xa1\xe6\xa1\x4a\xa1\x46\xa1\xb9\xa1\x03",
    "\xa1\x6e\xa1\xfa\xa1\xb8\xa1\xa7\xa1\xd4\xa1\x81",
    "",
    "",
    "",
    "",
    "",
    "",
    "\xa1\x6e\xa1\xfa\xa1\xb8\xa2\x10\xa1\x9b\xa2\x02\xa2\x14\xa1\x56\xa1\x86\xa1\x73\xa1\x03",
...
#ifdef VERSION_CN
char* D_800E798C[] = {
    "\xa1\x9b\xa2\x02\xa1\xca\xa2\x0e\xa1\x6e\xa1\xfa\xa1\xb8\xa1\x03",
    "",
    "\xa1\xbf\xa1\x59\xa1\xa9\xa1\xf3\xa1\x1b\xa1\x37\xa1\x2c\xa1\xfd\xa1\x06",
    "\xa1\xb6\xa2\x09\xa1\x7c\xa1\xc0\xa2\x01\xa1\xea\xa1\xb3\xa1\x06",
    "\xa1\xe4\xa1\xcb\xa2\x01\xa1\x69\xa1\xca\xa2\x0e\xa1\x6e\xa1\xfa\xa1\xb8\xa1\x00",
    ...
    "",
    "",
    "\xa1\xe6\xa1\x4a\xa1\x1b\xa1\x37",
    "\xa1\x03\xa1\x03\xa1\x03\xa1\x03\xa1\x03\xa1\x2c\xa1\xfd",
    "",
    "",
    "",
    "",
    ...
    "",
    "",
    "\xa1\x9b\xa2\x02\xa1\x03",
    "\xa2\x14\xa1\x56\xa1\x86\xa1\x73\xa1\x03",
    "",
    "\xa1\x07\xa1\x07\xa1\x03\xa1\x2c\xa1\xfd",
    "\xa1\x24\xa1\xa8\xa1\x1f\xa1\x1b\xa1\x37",
    "",
    "",
    "",
    "\xa1\xe6\xa1\x4a\xa1\x32\xa1\x77",
    "\xa1\x03\xa1\x03\xa1\x03\xa1\x03\xa1\x03\xa2\x01\xa1\xea\xa1\xd4\xa1\x81",
    "",
    "",
    "",
    "",
    "",
    "\xa1\x2c\xa1\xfd\xa1\x03",
    "\xa1\x03\xa1\x03\xa1\x03\xa1\x03\xa1\x03\xa1\xf7\xa1\x1f\xa1\x1b\xa1\x37",
    "",
    "",
    "",
    "",
...
#ifdef VERSION_CN
char* D_800E7A34[] = {
    "\xa1\x20\xa1\xc1\xa1\xd4\xa1\x81",
    "\xa1\xe6\xa1\x4a\xa1\x1b\xa1\x37\xa1\xe4\xa1\x2c\xa1\xfd",
};
#else
#ifdef VERSION_JP
char* D_800E7A34[] = {
...
#ifdef VERSION_CN
char* D_800E7A60[] = {
    "\xa2\x0c\xa1\x78\xa1\xc7\xa1\x31\xa1\xf8\xa1\xb3",
    "\xa1\x3f\xa1\xd4\xa1\x81\xa1\x00",
    "\xa1\xbc\xa1\x44\xa1\x9a\xa1\x12",
};
#else
#ifdef VERSION_JP
...
#ifdef VERSION_CN
char* D_800E7A74[] = {
    "\xa1\x1b\xa1\x37\xa1\x2c\xa1\xfd\xa2\x10\xa1\x01",
    "",
    "\xa1\xb6\xa1\xc9\xa1\x62",
};
#else
#ifdef VERSION_JP
char* D_800E7A74[] = {
...
#ifdef VERSION_CN
char* D_800E7A80[] = {
    "\xa1\xe6\xa1\x4a\xa1\x1b\xa1\x37\xa1\x03",
    "\xa1\x2c\xa1\xfd",
};
#else
#ifdef VERSION_JP
...
#ifdef VERSION_CN
char* D_800E7A88[] = {
    "\xa1\xa9\xa1\x68\xa1\x3e\xa1\x93",
    "\xa1\x7b\xa1\x1e",
    "\xa1\xfc\xa1\x1e",
    "\xa1\xdf\xa1\x1e",
...
#ifdef VERSION_CN
char* D_800E7A9C[] = {
    "\xa2\x13\xa1\x60\xa1\xa9\xa1\x04",
    "\xa1\xcf\xa1\x4d\xa1\xf6\xa1\x5c\xa1\x04",
};
#else
char* D_800E7A9C[] = {
    "CONGRATULATIONS!",
...
#ifdef VERSION_CN
char* gPlaceText[] = {
    "\xa1\xa9\xa1\xad\xa1\xa0",
    "\xa1\x41\xa1\x03\xa1\x03\xa1\x03\xa1\x03",
    "\xa1\x41\xa1\x03\xa1\x03\xa1\x03\xa1\x03",
    "\xa1\x41\xa1\x03\xa1\x03\xa1\x03\xa1\x03",
    "\xa1\x41\xa1\x03\xa1\x03\xa1\x03\xa1\x03",
    "\xa1\x41\xa1\x03\xa1\x03\xa1\x03\xa1\x03",
...
#ifdef VERSION_JP
Unk_D_800E70A0 D_800E8538[] = { { 0x73, 0x9b, 0x00, 0x00 } };
#else
...
Unk_D_800E70A0 D_800E8540[] = {
    ...
    { 0x78, 0x28, 0x00, 0x00 }, { 0x78, 0xa0, 0x00, 0x00 }, { 0x78, 0x28, 0x00, 0x00 }, { 0x78, 0xa0, 0x00, 0x00 },

    { 0x2b, 0x64, 0x00, 0x00 }, { 0xbc, 0x64, 0x00, 0x00 }, { 0x2b, 0x64, 0x00, 0x00 }, { 0xbc, 0x64, 0x00, 0x00 },

    { 0x2b, 0x28, 0x00, 0x00 }, { 0xbc, 0x28, 0x00, 0x00 }, { 0x2b, 0xa0, 0x00, 0x00 }, { 0xbc, 0xa0, 0x00, 0x00 },
};
#else
Unk_D_800E70A0 D_800E8540[] = {
    { 0x82, 0x64, 0x00, 0x00 }, { 0x82, 0x64, 0x00, 0x00 }, { 0x82, 0x64, 0x00, 0x00 }, { 0x82, 0x64, 0x00, 0x00 },
...
Unk_D_800E70A0 D_800E85C0[] = {
    { 0x78, 0x8c, 0x00, 0x00 }, { 0x78, 0x64, 0x00, 0x00 }, { 0x78, 0x64, 0x00, 0x00 }, { 0x78, 0x64, 0x00, 0x00 },

    { 0x78, 0x55, 0x00, 0x00 }, { 0x78, 0xcd, 0x00, 0x00 }, { 0x78, 0x28, 0x00, 0x00 }, { 0x78, 0xa0, 0x00, 0x00 },
};
#else
Unk_D_800E70A0 D_800E85C0[] = {
...
f64 menu_exponential(f64 arg0) {
    ...
    return menu_pow2((temp_f2 + arg0) / (temp_f2 - arg0), temp_f10);
}
...
Gfx* func_80096CD8(Gfx* displayListHead, s32 xPos, s32 yPos, u32 width, u32 height) {
    ...
    for (y = yPos; y < (yPos + height); y += tileHeight) {
        ...
        for (x = xPos; x < xPos + width; x += tileWidth) {
            ...
            gDPLoadTextureTile(displayListHead++, (sStaticNoiseTexture + random_int(128) * 2), G_IM_FMT_IA, G_IM_SIZ_16b, width,
...
void func_8009A9FC(s32 arg0, s32 arg1, u32 arg2, s32 arg3) {
    ...
    for (var_t1 = 0; (u32) var_t1 < arg2; var_t1++) {
        ...
        newred = ((((temp_t9 - red) * arg3) >> 8) + red);
        newgreen = ((((((temp_t9 * 7) / 8) - green) * arg3) >> 8) + green);
        newblue = ((((((temp_t9 * 6) / 8) - blue) * arg3) >> 8) + blue);
        color0++;
        *color1++ = (newblue << 1) + (newgreen << 6) + (newred << 0xB) + alpha;
    }
}
    ...
    if (arg0->visible) {
        ...
        switch (arg0->type) {             /* switch 6; irregular */
            ...
            case MENU_ITEM_UI_START_RECORD_TIME: {
                ...
                set_text_color(TEXT_GREEN);
#ifdef VERSION_JP
                print_text1_center_mode_1(0x000000A0, 0x0000008C, gCourseNamesDup[0], 0, 0.9f, 0.9f);
#else
            ...
            case MENU_ITEM_UI_NO_CONTROLLER: {
                ...
                for (strWidth = 0; strWidth < 2; strWidth++) {
#ifdef VERSION_JP
                    print_text1_center_mode_1(0xA0 * one - 3 * why,
                                              (s32) (0xB4 * one + ((f32) (strWidth * 0x12) * why)),
                                              gTextNoController[strWidth], 0, why, why);
#else
                    print_text1_center_mode_1(0xA0 * one - 1 * why,
...
void func_800A08D8(u8 arg0, s32 column, s32 row) {
    if (arg0 >= 0x10) {
        ...
        if (arg0 < 0x85) {
#ifndef VERSION_JP
            // JP's glyph table has all 0x85 entries; US clamps what it removed
            if (arg0 >= 0x32) {
                arg0 = 0x2B;
            }
#endif
...
#ifdef VERSION_JP
                print_text_mode_1(0x00000023, 0x41 + (0xD * var_s1), D_800E7940[(index * 4) + var_s1], 0, 0.75f, 0.75f);
#else
...
void render_menu_item_data_course_info(MenuItem* arg0) {
...
#ifdef VERSION_CN
    f32 scale;
    /* cn: 8 bytes of frame the cart reserves and never touches */
    ...
    set_text_color(TEXT_BLUE_GREEN_RED_CYCLE_1);
#ifdef VERSION_JP
    print_text1_center_mode_1(0x5A, arg0->row + 0x19, gCourseNamesDup[courseId], 0, 0.75f, 0.75f);
#else
...
#ifdef VERSION_JP
    print_text_mode_1(0x23, arg0->row + 0x28, (char*) &gTextDistance, 0, 0.75f, 0.75f);
    print_text1_left(0x91, arg0->row + 0x28, sCourseLengths[courseId], 1, 0.75f, 0.75f);
#else
...
#ifdef VERSION_JP
            print_text_mode_2(0x00000025, 0x46 + (0xD * i), gTextMenuOption[i], 0, 0.75f, 0.75f);
        } else {
...
#ifdef VERSION_JP
    sp78.column = 0x001D;
    sp78.row = (gCourseRecordsMenuSelection * 0xD) + 0x3E;
#else
    sp78.column = 0x001F;
...
void func_800A1DE0(MenuItem* arg0) {
    ...
    for (var_s1 = 0; var_s1 < 3; var_s1++) {
        print_text_mode_1(0x0000001B, 0x3C + (0xD * var_s1),
                          gEraseBestGhostText[(gCourseRecordsMenuSelection - 1) * 3 + var_s1], 0, scale, scale);
    }
    ...
    for (var_s1 = 0; var_s1 < ARRAY_COUNT(D_800E7840); var_s1++) {
        ...
        print_text_mode_1(0x00000043, 0x6E + (0xD * var_s1), D_800E7840[var_s1], 0, scale, scale);
    }
...
void func_800A1DE0(MenuItem* arg0) {
...
#ifdef VERSION_JP
        print_text_mode_1(0x0000001B, 0x3C + (0xD * var_s1),
                          gEraseBestGhostText[(gCourseRecordsMenuSelection - 1) * 3 + var_s1], 0, 0.75f, 0.75f);
#else
        print_text_mode_1(0x0000001B, 0x3C + (0xD * var_s1),
    ...
    for (var_s1 = 0; var_s1 < ARRAY_COUNT(D_800E7840); var_s1++) {
        ...
        set_text_color(var_a0);
#ifdef VERSION_JP
        print_text_mode_1(0x00000043, 0x6E + (0xD * var_s1), D_800E7840[var_s1], 0, 0.75f, 0.75f);
#else
...
void func_800A1FB0(MenuItem* arg0) {
    Unk_D_800E70A0 spE0;
    s32 var_s1;
#ifndef VERSION_JP  /* JP's frame is 0x10 smaller */
#ifndef VERSION_JP  /* JP frame */
    UNUSED s32 pad[2];
#endif
#endif
    UNUSED s32 temp;
...
#endif
#endif
    /* Declaration order is the frame layout here: IDO hands out a stack slot per
       declared local, downwards from the top, so pad4 belongs up here and sp98
       down after baseY. */
    char** promptText;
    UNUSED s32 pad4[3];
    s32 var_s5;
    ...
    switch (gSubMenuSelection) {
        ...
        case SUB_MENU_OPTION_ERASE_ALL_DATA:
            for (i = 0; i < ARRAY_COUNT(gTextOptionMenu); i++) {
                ...
                print_text_mode_1(0x00000046, 0x55 + (0x23 * i), gTextOptionMenu[i], 0, 1.0f, 1.0f);
        ...
        case SUB_MENU_ERASE_ERASE:
            ...
            for (i = 0; i < ARRAY_COUNT(D_800E7878); i++) {
                print_text_mode_1(0x0000001E, 0x55 + (0x14 * i), D_800E7878[i], 0, 1.0f, 1.0f);
            }
            for (i = 0; i < ARRAY_COUNT(D_800E7840); i++) {
                set_text_color_rainbow_if_selected(gSubMenuSelection - SUB_MENU_ERASE_MIN, i, 1);
                print_text_mode_1(0x00000096, 0x96 + (0x19 * i), D_800E7840[i], 0, 1.0f, 1.0f);
        ...
        case SUB_MENU_COPY_PAK_ERROR_BAD_READ_2P:
            ...
            for (i = 0; i < ARRAY_COUNT(D_800E78D0) / 4; i++) { // 12 / 4 = 3
                print_text_mode_1(0x00000032, 0x55 + (0x14 * i), D_800E78D0[(var_s1 * 3) + i], 0, someScale, someScale);
            }
            break;
        ...
        case SUB_MENU_COPY_PAK_ERROR_NO_PAGES_1P:
            ...
            someScale = 1.0f;
#else
            someScale = someScale3;
#endif
            var_s1 = gSubMenuSelection - SUB_MENU_COPY_PAK_ERROR_1P_MIN;
            for (i = 0; i < ARRAY_COUNT(D_800E7890) / 4; i++) { // 16 / 4 = 4
                print_text_mode_1(0x00000041, 0x55 + (i * 0x14), D_800E7890[(var_s1 * 4) + i], 0, someScale, someScale);
            }
            break;
        ...
        case SUB_MENU_COPY_PAK_UNABLE_READ_FROM_2P:
            ...
            for (i = 0; i < 2; i++) {
                print_text_mode_1(0x00000032, 0x55 + (0x14 * i), D_800E7900[(var_s1 * 2) + i], 0, someScale, someScale);
            }
            break;
...
#endif
            baseY = 0x96;
            print_text1_center_mode_1(0x000000A0, 0x00000055, D_800E7920[temp], 0, someScale, someScale);
            for (i = 0; i < ARRAY_COUNT(D_800E7918); i++) {
                set_text_color(TEXT_YELLOW);
                print_text1_center_mode_1(0x64 + (0x78 * i), 0x0000007D, D_800E7918[i], 0, someScale, someScale);
                for (j = 0; j < 2; j++) {
                    if (i != temp) {
                        text_rainbow_effect(gSubMenuSelection - var_s5, j, TEXT_GREEN);
                        if (j == (gSubMenuSelection - var_s5)) {
                            spE0.column = 0x23 + (0x87 * i);
...
#ifdef VERSION_JP
                    print_text_mode_1(0x23 + (0x87 * i), baseY + (0x1E * j), &spB8[1], 0, 0.75, 0.75);
#else
                    someScale2 = 0.75f;
                    print_text_mode_1(0x23 + (0x87 * i), baseY + (0x1E * j), &spB8[1], 0, someScale2, someScale2);
#endif
                    if (i == 0) {
                        var_v1 = &D_8018EE10[j];
                    } else {
                    ...
                    if (var_v1->ghostDataSaved == 0) {
                        print_text_mode_1(0x32 + (i * 0x87), baseY + (0x1E * j), D_800E7A44, 0, 0.75, 0.75);
                    } else {
                        print_text_mode_1(
                            0x32 + (i * 0x87), baseY + (0x1E * j),
        ...
        case SUB_MENU_COPY_PAK_PROMPT_COPY:
            ...
            for (i = 0; i < ARRAY_COUNT(D_800E7928); i++) {
                print_text1_center_mode_1(0x000000A0, 0x4D + (0x14 * i), D_800E7928[i], 0, someScale, someScale);
            }
            for (i = 0; i < ARRAY_COUNT(D_800E7918); i++) {
                set_text_color(TEXT_YELLOW);
                print_text1_center_mode_1(0x64 + (0x78 * i), 0x0000007D, D_800E7918[i], 0, someScale, someScale);
                for (j = 0; j != 2; j++) {
...
#ifdef VERSION_JP
                    print_text_mode_1(0x23 + (0x87 * i), 0x96 + (0x1E * j), &spA8[1], 0, 0.75, 0.75);
#else
                    print_text_mode_1(0x23 + (0x87 * i), 0x96 + (0x1E * j), &spA8[1], 0, someScale3, someScale3);
#endif
                    if (i == 0) {
                        do {
                        } while (0); // FAKE
                    ...
                    if (var_v1->ghostDataSaved == 0) {
                        print_text_mode_1(0x32 + (i * 0x87), 0x96 + (0x1E * j), D_800E7A44, 0, 0.75, 0.75);
                    } else {
                        print_text_mode_1(
                            0x32 + (i * 0x87), 0x96 + (0x1E * j),
                            gCourseNamesDup2[gCupCourseOrder[var_v1->courseIndex / 4][var_v1->courseIndex % 4]], 0,
                            0.75, 0.75);
                    }
                }
            ...
            for (i = 0; i < ARRAY_COUNT(D_800E7930); i++) {
                ...
                if (i == (gSubMenuSelection - SUB_MENU_COPY_PAK_PROMPT_MIN)) {
                    spE0.column = 0x6E + promptCol;
                    spE0.row = 0x00D2;
                }
                text_rainbow_effect((gSubMenuSelection - SUB_MENU_COPY_PAK_PROMPT_MIN), j, TEXT_YELLOW);
#ifdef VERSION_JP
                promptText = D_800E7930;
                print_text_mode_1(0x6E + (0x32 * i), 0x000000D2, promptText[i], 0, 0.75, 0.75);
#else
                print_text_mode_1(0x6E + (0x32 * i), 0x000000D2, D_800E7930[i], 0, someScale, someScale);
#endif
            }
            break;
...
#ifdef VERSION_JP
                    print_text_mode_1(0x23 + (0x87 * i), 0x96 + (0x1E * j), &sp98[1], 0, 0.75, 0.75);
#else
                    print_text_mode_1(0x23 + (0x87 * i), 0x96 + (0x1E * j), &sp98[1], 0, someScale3, someScale3);
#endif
                    if (i == 0) {
                        var_v1 = &D_8018EE10[j];
                    } else {
...
void func_800A2EB8(MenuItem* arg0) {
    ...
    for (var_s2 = 0; var_s2 < 4; var_s2++) {
        ...
        set_text_color(var_a0);
#ifdef VERSION_CN
        func_800A32B4(arg0->column + 7, (arg0->row + 0x38) + (0x10 * var_s2), (s32) sp70[var_s2], var_s2);
#else
    ...
    for (var_s2 = 4; var_s2 < 8; var_s2++) {
        ...
        set_text_color(var_a0);
#ifdef VERSION_CN
        func_800A32B4(0xBE - arg0->column, (arg0->row + 0x5A) + (0x10 * var_s2), sp70[var_s2], var_s2);
#else
    ...
    set_text_color(TEXT_BLUE_GREEN_RED_CYCLE_2);
#ifdef VERSION_JP
    print_text_mode_1(0xC3 - arg0->column, arg0->row + 0xE1, gCupNames[D_800DC540], 0, 0.7f, 0.7f);
    print_text_mode_1(0x113 - arg0->column, arg0->row + 0xE1,
                      D_800E76CC[gGameModeSubMenuColumn[gPlayerCount - 1][gGameModeMenuColumn[gPlayerCount - 1]]], 0,
                      0.7f, 0.7);
#else
    temp_s0 = (s32) (((f32) (get_string_width(gCupNames[gCupSelection]) + 8) * 0.6f) / 2);
#ifdef VERSION_CN
    new_var = (s32) (((f32) (get_string_width(D_800E76CC[gCCSelection]) + 8) * 0.6f) / 2);
#endif
    print_text1_center_mode_1(
#ifdef VERSION_CN
        (0xF5 - new_var) - arg0->column,
#else
    ...
    print_text1_center_mode_1(
#ifdef VERSION_CN
        (temp_s0 + 0xF5) - arg0->column, arg0->row + 0xE1,
#else
...
void func_800A32B4(s32 arg0, s32 arg1, s32 characterId, s32 rank) {
    ...
    sp3C[3] = '\0';
#ifdef VERSION_CN
    func_800939C8(arg0 - 1, arg1, &sp3C[1], -4, sc, sc);
    print_text_mode_1(arg0 + 0xA, arg1, D_800E76A8[characterId], 0, 0.65f, sc);
    convert_number_to_ascii(mins, sp3C);
    func_800939C8(arg0 + 0x42, arg1, sp3C, 0, sc, sc);
    convert_number_to_ascii(secs, sp3C);
    print_text_mode_1(arg0 + 0x4E, arg1, "'", 0, sc, sc);
    func_800939C8(arg0 + 0x56, arg1, sp3C, 0, sc, sc);
    convert_number_to_ascii(cents, sp3C);
    print_text_mode_1(arg0 + 0x62, arg1, "\"", 0, sc, sc);
    func_800939C8(arg0 + 0x6A, arg1, sp3C, 0, sc, sc);
#else
    func_800939C8(arg0 - 1, arg1, &sp3C[1], -4, 0.7f, 0.7f);
#ifdef VERSION_JP
    print_text_mode_1(arg0 + 0xA, arg1, D_800E76A8[characterId], 0, 0.7f, 0.7f);
#else
...
void func_800A34A8(MenuItem* arg0) {
    ...
    UNUSED s32 stackPadding0;
    char sp78[3];
#ifndef VERSION_JP  /* JP's frame is 8 bytes smaller here */
    UNUSED s32 stackPadding1;
#endif
    /* JP declares test here, which is what puts its spill slot at 0x58 not 0x5c. */
    s32 test;
    s32 var_a0;
    s32 var_v0;
    s32 var_v1;
    ...
    if (arg0->state != 0) {
        ...
        set_text_color(TEXT_BLUE_GREEN_RED_CYCLE_1);
        print_text_mode_1(arg0->column + 0x1E, 0x19 - arg0->row, "driver's point", 0, 0.8, 0.8);
        set_text_color(TEXT_BLUE_GREEN_RED_CYCLE_2);
        print_text_mode_1(arg0->column + 0x36, 0x28 - arg0->row, "round", 0, 0.7, 0.7);
        convert_number_to_ascii(gCourseIndexInCup + 1, sp78);
        print_text_mode_1(arg0->column + 0x61, (0x28 & 0xFFFFFFFF) - arg0->row, &sp78[1], 0, 0.7, 0.7);
        ...
        set_text_color(TEXT_BLUE_GREEN_RED_CYCLE_2);
        print_text_mode_1(0xAF - arg0->column, arg0->row + 0xE1, gCupNames[D_800DC540], 0, 0.7f, 0.7f);
        print_text_mode_1(0x104 - arg0->column, arg0->row + 0xE1,
                          D_800E76CC[gGameModeSubMenuColumn[gPlayerCount - 1][gGameModeMenuColumn[gPlayerCount - 1]]],
                          0, 0.7, 0.7);
    }
}
#else
void func_800A34A8(MenuItem* arg0) {
    ...
    if (arg0->state != 0) {
        ...
        convert_number_to_ascii(gCourseIndexInCup + 1, sp78);
#ifdef VERSION_CN
        print_text_mode_1(arg0->column + 0x61, -arg0->row + 0x28, &sp78[1], 0, 0.7f, 0.7f);
#else
        ...
        for (rank = 0; rank < 4; rank++) {
            ...
            if (var_v0 == 0) {
                ...
                set_text_color(var_a0);
#ifdef VERSION_CN
                temp_y1 = (rank * 0x10) + 0x38;
                func_800A3ADC(arg0, arg0->column + var_v1 + 0x1C, temp_y1 - arg0->row, sp80[rank], rank, sp80);
#else
                func_800A3ADC(arg0, arg0->column + var_v1 + 0x1C, ((rank * 0x10) - arg0->row) + 0x38, sp80[rank], rank,
                              sp80);
#endif
        ...
        for (rank = 4; rank < NUM_PLAYERS; rank++) {
            ...
            if (var_v0 == 0) {
                ...
                set_text_color(var_a0);
#ifdef VERSION_CN
                temp_y2 = (rank * 0x10) + 0x5A;
                func_800A3ADC(arg0, 0xBE - arg0->column, arg0->row + temp_y2, sp80[rank], rank, sp80);
#else
                func_800A3ADC(arg0, 0xBE - arg0->column, arg0->row + (rank * 0x10) + 0x5A, sp80[rank], rank, sp80);
#endif
            }
...
#ifdef VERSION_CN
        temp_w1 = ((get_string_width(D_800E76CC[gCCSelection]) + 8) * 0.6f) / 2;
        temp_x2 = 0xE6 - arg0->column;
        print_text1_center_mode_1(temp_x2 - temp_w1, arg0->row + 0xE1, gCupNames[D_800DC540], 0, 0.6f, 0.6f);
        temp_x1 = arg0->column - 0xE6;
#endif
        print_text1_center_mode_1(
#ifdef VERSION_CN
            temp_s0_3 - temp_x1, arg0->row + 0xE1,
#else
...
#ifdef VERSION_CN
            if (gGPPointsByCharacterId[temp_t1] > gGPPointsByCharacterId[temp_a3]) {
                arg0[var_a1] = arg0[var_a1 - 1];
#else
...
void time_trials_finish_text_render(MenuItem* arg0) {
    ...
    print_text1_center_mode_1(arg0->column + 0x43, arg0->row + 0x19,
                              gCourseNamesDup[gCupCourseOrder[gCupSelection][gCourseIndexInCup]], 0, sc, sc);

    // lap time text
    sc = 0.75f;
    set_text_color(TEXT_YELLOW);
    lapStrPtr = &gLapTimeText;
    print_text1_center_mode_1(arg0->column + 0x46, arg0->row + 0x28, *lapStrPtr, 0, sc, sc);
#else
#ifdef VERSION_JP
    print_text1_center_mode_1(arg0->column + 0x46, arg0->row + 0x19,
                              gCourseNamesDup[gCupCourseOrder[gCupSelection][gCourseIndexInCup]], 0, 0.75f, 0.75f);
#else
    print_text1_center_mode_1(arg0->column + 0x43, arg0->row + 0x19,
    ...
    set_text_color(TEXT_YELLOW);
#ifdef VERSION_CN
    print_text_mode_1(0xB4 - arg0->column, arg0->row + 0x86, gBestTimeText[0], 0, sc, sc);

    // best record
    for (recordType = 0; recordType < TIME_TRIAL_1LAP_RECORD; recordType += 1) {
        set_text_color(TEXT_RED);
        render_lap_times(recordType, 0xAA - arg0->column, arg0->row + (recordType * 0xD) + 0x92);
    }
    set_text_color(TEXT_YELLOW);
    print_text_mode_1(0xB4 - arg0->column, arg0->row + 0xD5, gBestTimeText[1], 0, sc, sc);
#else
...
void func_800A3E60(MenuItem* arg0) {
    ...
    UNUSED s32 stackPadding4;
#endif
    /* IDO gives every declared local a stack slot, handed out downwards from the
       top of the frame in declaration order, so this order is what puts sp60 at
       0x60 and var_v1 at 0x6c. */
    s32 var_s1;
    ...
    var_v0 = arg0->state;
    if ((var_v0 == 0) || (var_v0 == 0x0000001F)) {
        return;
    }

    someScale2 = someScale;
    set_text_color(TEXT_BLUE_GREEN_RED_CYCLE_1);
    print_text1_center_mode_1(arg0->column + 0x55, 0x19 - arg0->row,
                              gCourseNamesDup[gCupCourseOrder[gCupSelection][gCourseIndexInCup]], 0, someScale, someScale);
    set_text_color(TEXT_YELLOW);
    print_text1_center_mode_1(arg0->column + 0x55, 0x28 - arg0->row, gLapTimeText, 0, someScale, someScale);
    for (var_s1 = 0; var_s1 < 4; var_s1++) {
    ...
    switch (arg0->state) {
...
#ifdef VERSION_JP
                    rowPtr = &arg0->row;
                    print_text_mode_2(0xB9 - arg0->column, *rowPtr + (0xD * var_s1) + 0x93,
                                      gTextPauseButton[var_s1 + 1], 0, someScale, someScale);
                } else {
                    print_text_mode_1(0xB9 - arg0->column, arg0->row + (0xD * var_s1) + 0x93,
                                      gTextPauseButton[var_s1 + 1], 0, someScale, someScale);
                }
#else
        ...
        case 16:
            ...
            for (var_s1 = 0; var_s1 < 5; var_s1++) {
                print_text_mode_1(0x000000AA, 0x93 + (0xD * var_s1), D_800E798C[(var_v1 * 5) + var_s1], 0, someScale2,
                                  someScale2);
            }
            break;
        case 17:
        case 18:
            ...
            for (var_s1 = 0; var_s1 < 2; var_s1++) {
                print_text_mode_1(0x000000AA, arg0->row + (0xD * var_s1) + 0x8C, D_800E7A3C[var_s1], 0, someScale,
                                  someScale);
            }
            someScale3 = 0.7f;
            for (var_s1 = 0; var_s1 < 2; var_s1++) {
                ...
                print_text_mode_1(0xB4 - arg0->column, 0xAA + (0x1E * var_s1), &sp60[1], 0, someScale2, someScale2);
                if (D_8018EE10[var_s1].ghostDataSaved == 0) {
                    someScale2 = someScale;
                    print_text_mode_1(0xC3 - arg0->column, 0xAA + (0x1E * var_s1), D_800E7A44, 0, someScale, someScale);
                } else {
                    someScale2 = someScale3;
                    print_text_mode_1(0xC3 - arg0->column, 0xAA + (0x1E * var_s1),
                                      gCourseNamesDup2[gCupCourseOrder[D_8018EE10[var_s1].courseIndex / 4]
                                                                      [D_8018EE10[var_s1].courseIndex % 4]],
                                      0, someScale3, someScale3);
                    goto skip_ghost_name; // fake
                skip_ghost_name:;
                }
            }
            break;
        case 19:
            set_text_color(TEXT_YELLOW);
            for (var_s1 = 0; var_s1 < 3; var_s1++) {
                print_text_mode_1(0x000000AA, (0xD * var_s1) + 0x93, D_800E7A48[var_s1], 0, someScale, someScale);
            }
            break;
        case 20:
        case 21:
            ...
            for (var_s1 = 0; var_s1 < 3; var_s1++) {
#ifdef VERSION_JP
                print_text_mode_1(0x000000AF, arg0->row + (0xD * var_s1) + 0x8C, D_800E7A60[var_s1], 0, someScale2,
                                  someScale2);
#else
                print_text_mode_1(0x000000A3, arg0->row + (0xD * var_s1) + 0x8C, D_800E7A60[var_s1], 0, someScale2,
                                  someScale2);
#endif
            }
            for (var_s1 = 0; var_s1 < 2; var_s1++) {
                text_rainbow_effect(arg0->state - 0x14, var_s1, 1);
                print_text_mode_1(0xC8 - arg0->column, 0xB9 + (0xF * var_s1), D_800E7A6C[var_s1], 0, someScale, someScale);
            }
            break;
        case 25:
            set_text_color(TEXT_YELLOW);
            for (var_s1 = 0; var_s1 < 3; var_s1++) {
#ifdef VERSION_JP
                print_text_mode_1(0x000000AA, (0xD * var_s1) + 0x93, D_800E7A74[var_s1], 0, someScale2, someScale2);
#else
                print_text_mode_1(0x000000A3, (0xD * var_s1) + 0x93, D_800E7A74[var_s1], 0, someScale2, someScale2);
#endif
            }
            break;
        case 26:
            set_text_color(TEXT_YELLOW);
            for (var_s1 = 0; var_s1 < 2; var_s1++) {
                print_text_mode_1(0x000000AA, (0xD * var_s1) + 0x93, D_800E7A80[var_s1], 0, someScale, someScale);
            }
            break;
    }
...
void func_800A3E60(MenuItem* arg0) {
...
#ifdef VERSION_CN
    scale = 0.6f;
    print_text1_center_mode_1(arg0->column + 0x55, -arg0->row + 0x19,
                              gCourseNamesDup[gCupCourseOrder[gCupSelection][gCourseIndexInCup]], 0, scale, scale);
    scale = 0.75f;
#else
    print_text1_center_mode_1(arg0->column + 0x55, 0x19 - arg0->row,
                              gCourseNamesDup[gCupCourseOrder[gCupSelection][gCourseIndexInCup]], 0, 0.6f, 0.6f);
    ...
    set_text_color(TEXT_YELLOW);
#ifdef VERSION_CN
    /* cn: gBestTimeText[2] is gLapTimeText; the array spelling is what the ROM was built from */
    print_text1_center_mode_1(arg0->column + 0x55, -arg0->row + 0x28, gBestTimeText[2], 0, scale, scale);
#else
    ...
    switch (arg0->state) {
        ...
        case 30:
            for (var_s1 = 0; var_s1 < 6; var_s1++) {
                ...
                if (var_v1 != 0) {
                    ...
                    gDPSetPrimColor(gDisplayListHead++, 0, 0, 0x00, 0x00, 0x00, 0x96);
#ifdef VERSION_CN
                    print_text_mode_2(0xB7 - arg0->column, (arg0->row + 0x93) + (0xD * var_s1),
                                      gTextPauseButton[var_s1 + 1], 0, scale, scale);
#else
                    print_text_mode_2(0xB2 - arg0->column, arg0->row + (0xD * var_s1) + 0x93,
...
#ifdef VERSION_CN
                    print_text_mode_1(0xB7 - arg0->column, (arg0->row + 0x93) + (0xD * var_s1),
                                      gTextPauseButton[var_s1 + 1], 0, scale, scale);
#else
                    print_text_mode_1(0xB2 - arg0->column, arg0->row + (0xD * var_s1) + 0x93,
                                      gTextPauseButton[var_s1 + 1], 0, 0.75f, 0.75f);
...
#ifdef VERSION_CN
                print_text_mode_1(0x000000A2, 0x8C + (0xD * var_s1), D_800E798C[(var_v1 * 7) + var_s1], 0, scale, scale);
#else
        ...
        case 18:
            ...
            for (var_s1 = 0; var_s1 < 2; var_s1++) {
#ifdef VERSION_CN
                print_text_mode_1(0x000000A5, (arg0->row + 0x8C) + (0xD * var_s1), D_800E7A3C[var_s1], 0, scale, scale);
#else
            ...
            for (var_s1 = 0; var_s1 < 2; var_s1++) {
#ifdef VERSION_CN
                ghostHighlight = 0;
                ghost = &D_8018EE10[1 - var_s1];
#endif
                text_rainbow_effect(arg0->state - 0x11, var_s1, 1);
#ifdef VERSION_CN
                scale = 0.7f;
                /* cn only: dim-blue backing when the other slot's ghost is for the course on screen */
                if (ghost->ghostDataSaved != 0) {
                    courseIdx = ghost->courseIndex;
                    if ((courseIdx / 4 == gCupSelection) && (courseIdx % 4 == gCourseIndexInCup)) {
                        set_text_color(TEXT_BLUE);
                        gDPSetPrimColor(gDisplayListHead++, 0, 0, 0x00, 0x00, 0x00, 0x96);
                        ghostHighlight = 1;
                    }
...
#ifdef VERSION_CN
                if (ghostHighlight != 0) {
                    print_text_mode_2(0xB1 - arg0->column, 0xAA + (0x1E * var_s1), &sp60[1], 0, scale, scale);
                } else {
                    print_text_mode_1(0xB1 - arg0->column, 0xAA + (0x1E * var_s1), &sp60[1], 0, scale, scale);
                }
#else
                ...
                if (D_8018EE10[var_s1].ghostDataSaved == 0) {
                    ...
                    scale = 0.7f;
                    if (ghostHighlight != 0) {
                        print_text_mode_2(0xC1 - arg0->column, 0xAA + (0x1E * var_s1), D_800E7A3C[2], 0, scale, scale);
                    } else {
                        print_text_mode_1(0xC1 - arg0->column, 0xAA + (0x1E * var_s1), D_800E7A3C[2], 0, scale, scale);
                    }
#else
...
#ifdef VERSION_CN
                    scale = 0.7f;
                    courseIdx2 = D_8018EE10[var_s1].courseIndex;
                    if (ghostHighlight != 0) {
                        print_text_mode_2(0xC1 - arg0->column, 0xAA + (0x1E * var_s1),
                                          gCourseNamesDup2[gCupCourseOrder[courseIdx2 / 4][courseIdx2 % 4]], 0, scale,
                                          scale);
                    } else {
                        print_text_mode_1(0xC1 - arg0->column, 0xAA + (0x1E * var_s1),
                                          gCourseNamesDup2[gCupCourseOrder[courseIdx2 / 4][courseIdx2 % 4]], 0, scale,
                                          scale);
                    }
#else
        ...
        case 19:
            ...
            for (var_s1 = 0; var_s1 < 3; var_s1++) {
#ifdef VERSION_CN
                print_text_mode_1(0x000000AA, (0xD * var_s1) + 0x93, D_800E7A48[var_s1], 0, scale, scale);
#else
        ...
        case 21:
            ...
            for (var_s1 = 0; var_s1 < 3; var_s1++) {
#ifdef VERSION_CN
                print_text_mode_1(0x000000A3, (arg0->row + 0x8C) + (0xD * var_s1), D_800E7A60[var_s1], 0, scale, scale);
#else
            ...
            for (var_s1 = 0; var_s1 < 2; var_s1++) {
                text_rainbow_effect(arg0->state - 0x14, var_s1, 1);
#ifdef VERSION_CN
                print_text_mode_1(0xC8 - arg0->column, 0xB9 + (0xF * var_s1), D_800E7A6C[var_s1], 0, scale, scale);
#else
        ...
        case 25:
            ...
            for (var_s1 = 0; var_s1 < 3; var_s1++) {
#ifdef VERSION_CN
                print_text_mode_1(0x000000A3, (0xD * var_s1) + 0x93, D_800E7A74[var_s1], 0, scale, scale);
#else
        ...
        case 26:
            ...
            for (var_s1 = 0; var_s1 < 2; var_s1++) {
#ifdef VERSION_CN
                print_text_mode_1(0x000000AA, (0xD * var_s1) + 0x93, D_800E7A80[var_s1], 0, scale, scale);
#else
...
void render_lap_times(s32 recordType, s32 column, s32 row) {
    ...
    func_800939C8(column + 0x14, row, D_800E7744[recordType], 2, scale, scale);
#else
...
#ifdef VERSION_CN
    func_800939C8(column + 0x2A, row, sp38, 0, scale, scale);
    print_text_mode_1(column + 0x35, row, "'", 0, scale, scale);
#else
...
#ifdef VERSION_CN
    func_800939C8(column + 0x3E, row, sp38, 0, scale, scale);
    print_text_mode_1(column + 0x49, row, "\"", 0, scale, scale);
#else
...
#ifdef VERSION_CN
    func_800939C8(column + 0x53, row, sp38, 0, scale, scale);
#else
...
#ifdef VERSION_CN
    print_text1_center_mode_1(column + 0x7D, row, D_800E76A8[textColor], 0, scale, scale);
#else
...
void render_menu_item_announce_ghost(MenuItem* arg0) {
    ...
    s32 temp_t1;
    s32 temp_t2;
    f32 someMultiplier = 1.0f;
    s32 thing = (someMultiplier + 0.5) * 16.0;

    temp_t0 = 0x140 - arg0->column;
    temp_t1 = arg0->row;
    temp_t2 = (get_string_width(gTextMenuAnnounceGhost) + 30) / 2;
    gDisplayListHead = draw_box(gDisplayListHead, temp_t0 - temp_t2, (temp_t1 - thing) + 4, temp_t2 + temp_t0,
                                temp_t1 + 4, 0, 0, 0, 0x00000064);
    set_text_color(TEXT_BLUE_GREEN_RED_CYCLE_1);
    print_text1_center_mode_1(arg0->column - 3, arg0->row, gTextMenuAnnounceGhost, 0, 1.0f, 1.0f);
}
#else
void render_menu_item_announce_ghost(MenuItem* arg0) {
    UNUSED s32 stackPadding0;
...
void render_pause_menu_time_trials(MenuItem* arg0) {
...
#endif
#ifdef VERSION_JP
    print_text1_center_mode_1(0x000000A0, 0x00000060, gBestTimeText[0], 0, 0.8f, 0.8f);
#else
#ifdef VERSION_CN
    print_text1_center_mode_1(0x0000009D, 0x00000060, gBestTimeText[0], 0, scale, scale);
#else
...
#ifdef VERSION_CN
    func_800939C8(0x0000007F, 0x0000006D, sp68, 0, scale, scale);
    print_text_mode_1(0x0000008E, 0x0000006D, "'", 0, scale, scale);
#else
...
#ifdef VERSION_CN
    func_800939C8(0x00000098, 0x0000006D, sp68, 0, scale, scale);
    print_text_mode_1(0x000000A7, 0x0000006D, "\"", 0, scale, scale);
#else
...
#ifdef VERSION_CN
    func_800939C8(0x000000B3, 0x0000006D, sp68, 0, scale, scale);
#else
    func_800939C8(0x000000B3, 0x0000006D, sp68, 0, 0.8f, 0.8f);
#endif
#ifdef VERSION_JP
    print_text1_center_mode_1(0x000000A0, 0x0000007C, gBestTimeText[1], 0, 0.8f, 0.8f);
#else
#ifdef VERSION_CN
    print_text1_center_mode_1(0x0000009D, 0x0000007C, gBestTimeText[1], 0, scale, scale);
#else
    ...
    get_time_record_minutes(temp_a0, sp68);
#ifdef VERSION_CN
    func_800939C8(0x0000007F, 0x00000089, sp68, 0, scale, scale);
    print_text_mode_1(0x0000008E, 0x00000089, "'", 0, scale, scale);
#else
    ...
    get_time_record_seconds(temp_a0, sp68);
#ifdef VERSION_CN
    func_800939C8(0x00000098, 0x00000089, sp68, 0, scale, scale);
    print_text_mode_1(0x000000A7, 0x00000089, "\"", 0, scale, scale);
#else
    ...
    get_time_record_centiseconds(temp_a0, sp68);
#ifdef VERSION_CN
    func_800939C8(0x000000B3, 0x00000089, sp68, 0, scale, scale);
    new_var = D_800E8538 + zero;
#else
...
#ifdef VERSION_CN
        print_text_mode_1(new_var->column, new_var->row + (13 * var_s0), gTextPauseButton[var_s0], 0, scale,
                          scale);
#else
...
#ifdef VERSION_JP
        print_text_mode_1(temp_s3->column, temp_s3->row + (13 * var_s0), gTextPauseButton[var_s1], 0, 0.75f, 0.75f);
#else
...
void render_pause_grand_prix(MenuItem* arg0) {
    ...
    scale = 1.0f;
    set_text_color(TEXT_YELLOW);
    print_text1_center_mode_1(160 - temp_s1, temp_s3->row - 50, gCupNames[gCupSelection], 0, scale, scale);
    set_text_color(TEXT_YELLOW);
    print_text1_center_mode_1(160 + temp_s0, temp_s3->row - 50, D_800E76CC[gCCSelection], 0, scale, scale);
    set_text_color(TEXT_YELLOW);
    ...
    for (var_s0 = 0; var_s0 < 2; var_s0++) {
        ...
        print_text_mode_1(temp_s3->column, temp_s3->row + (var_s0 * 13), gTextPauseButton[var_s0 * 4], 0, scale, scale);
    }
#else
    temp_s1 = ((get_string_width(D_800E76CC[gCCSelection]) * one) + 10.0f) / 2;
    set_text_color(TEXT_YELLOW);
...
#ifdef VERSION_JP
        print_text_mode_1(temp_s3->column, temp_s3->row + 13 * var_a1, gTextPauseButton[var_s1], 0, 0.75f, 0.75f);
#else
...
void render_menu_item_end_course_option(MenuItem* arg0) {
    ...
    /* JP hoists the seconds mark into a variable, which is what puts the
       sp84/sp5C block 4 bytes lower in the frame. */
    char* secondMark;
    char sp5C[3];

    if (arg0->state == 0) {
        if ((arg0->param1 >= 0x1E) && ((gGlobalTimer / 16) % 2)) {
            someScale = get_string_width(gTextPauseButton[REPLAY]) * 0.8f;
            gDisplayListHead =
                draw_box(gDisplayListHead, 0x000000C0, 0x00000022, (s32) (someScale) + 0xC6, 0x00000033, 0, 0, 0, 0x00000096);
            set_text_color(TEXT_GREEN);
            print_text_mode_1(0x000000C3, 0x00000030, gTextPauseButton[REPLAY], 0, 0.8f, 0.8f);
        }
    } else {
        if (arg0->state == 1) {
            var_s1 = arg0->param1;
        ...
        switch (arg0->state) {
            ...
            case 16:
                set_text_color(TEXT_RED);
                print_text1_center_mode_2(0x000000A0, 0x00000060, gBestTimeText[0], 0, someScale, someScale);
                temp_a0 = func_800B4E24(0);
                temp_a0 &= 0xFFFFF;
                get_time_record_minutes(temp_a0, sp84);
                text_draw(0x0000007F, 0x0000006D, sp84, 0, someScale, someScale);
                print_text_mode_2(0x0000008E, 0x0000006D, "'", 0, someScale, someScale);
                secondMark = "\"";
                get_time_record_seconds(temp_a0, sp84);
                text_draw(0x00000098, 0x0000006D, sp84, 0, someScale, someScale);
                print_text_mode_2(0x000000A7, 0x0000006D, secondMark, 0, someScale, someScale);
                get_time_record_centiseconds(temp_a0, sp84);
                text_draw(0x000000B3, 0x0000006D, sp84, 0, someScale, someScale);
                print_text1_center_mode_2(0x000000A0, 0x0000007C, gBestTimeText[1], 0, someScale, someScale);
                temp_a0 = func_800B4F2C();
                temp_a0 &= 0xFFFFF;
                get_time_record_minutes(temp_a0, sp84);
                text_draw(0x0000007F, 0x00000089, sp84, 0, someScale, someScale);
                print_text_mode_2(0x0000008E, 0x00000089, "'", 0, someScale, someScale);
                get_time_record_seconds(temp_a0, sp84);
                text_draw(0x00000098, 0x00000089, sp84, 0, someScale, someScale);
                secondMark = "\"";
                print_text_mode_2(0x000000A7, 0x00000089, secondMark, 0, someScale, someScale);
                get_time_record_centiseconds(temp_a0, sp84);
                text_draw(0x000000B3, 0x00000089, sp84, 0, someScale, someScale);
                someScale = 0.75f;
                for (var_s1 = 0; var_s1 < 6; var_s1++) {
            ...
            case 26:
                ...
                for (var_s1 = 0; var_s1 < 5; var_s1++) {
                    print_text_mode_1(0x00000064, 0x6E + (0xD * var_s1), D_800E798C[(temp_v0 * 5) + var_s1], 0,
                                      someScale, someScale);
                }
                break;
            case 30:
            case 31:
                set_text_color(TEXT_GREEN);
                for (var_s1 = 0; var_s1 < 2; var_s1++) {
                    print_text_mode_1(0x00000064, arg0->row + (0xD * var_s1) + 0x6E, D_800E7A3C[var_s1], 0, someScale,
                                      someScale);
                }
                someScale = 0.75f;
                for (var_s1 = 0; var_s1 < 2; var_s1++) {
                    ...
                    print_text_mode_1(0x6E - arg0->column, (0x96 + (0x14 * var_s1)), &sp5C[1], 0, why, why);
                    why = someScale;
                    if (D_8018EE10[var_s1].ghostDataSaved == 0) {
                        print_text_mode_1(0x7D - arg0->column, (0x96 + (0x14 * var_s1)), D_800E7A44, 0, someScale,
                                          someScale);
                    } else {
                        print_text_mode_1(0x7D - arg0->column, (0x96 + (0x14 * var_s1)),
                                          gCourseNamesDup2[gCupCourseOrder[D_8018EE10[var_s1].courseIndex / 4]
                                                                          [D_8018EE10[var_s1].courseIndex % 4]],
                                          0, someScale, someScale);
                    }
                }
                break;
            case 32:
                set_text_color(TEXT_YELLOW);
                for (var_s1 = 0; var_s1 < 3; var_s1++) {
                    print_text_mode_1(0x00000064, (0xD * var_s1) + 0x6E, D_800E7A48[var_s1], 0, someScale, someScale);
                }
                break;
            case 35:
            case 36:
                set_text_color(TEXT_YELLOW);
                for (var_s1 = 0; var_s1 < 3; var_s1++) {
                    print_text_mode_1(0x00000064, arg0->row + (0xD * var_s1) + 0x6E, D_800E7A60[var_s1], 0, someScale, someScale);
                }
                for (var_s1 = 0; var_s1 < 2; var_s1++) {
                    text_rainbow_effect(arg0->state - 0x23, var_s1, TEXT_GREEN);
                    print_text_mode_1(0x7D - arg0->column, 0x9B + (0xF * var_s1), D_800E7A6C[var_s1], 0, someScale, someScale);
                }
                break;
            case 40:
                set_text_color(TEXT_YELLOW);
                for (var_s1 = 0; var_s1 < 3; var_s1++) {
                    print_text_mode_1(0x00000064, (0xD * var_s1) + 0x6E, D_800E7A74[var_s1], 0, someScale, someScale);
                }
                break;
            case 41:
                set_text_color(TEXT_YELLOW);
                for (var_s1 = 0; var_s1 < 2; var_s1++) {
                    print_text_mode_1(0x00000064, (0xD * var_s1) + 0x6E, D_800E7A80[var_s1], 0, someScale, someScale);
                }
                break;
        }
        switch (arg0->state) { /* switch 2 */
...
void render_menu_item_end_course_option(MenuItem* arg0) {
    ...
    if (arg0->state == 0) {
        if ((arg0->param1 >= 0x1E) && ((gGlobalTimer / 16) % 2)) {
            someScale = 0.8f;
            why = get_string_width(gTextPauseButton[REPLAY]) * someScale;
            temp_v0 = (s32) why;
            gDisplayListHead =
                draw_box(gDisplayListHead, 0x000000C0, 0x00000021, temp_v0 + 0xC6, 0x00000032, 0, 0, 0, 0x00000096);
            set_text_color(TEXT_GREEN);
            print_text_mode_1(0x000000C4, 0x0000002F, gTextPauseButton[REPLAY], 0, someScale, someScale);
        }
    } else {
        if (arg0->state == 1) {
            var_s1 = arg0->param1;
        ...
        set_text_color(TEXT_YELLOW);
        print_text1_center_mode_2(0x000000A0, 0x00000050,
                                  gCourseNamesDup[gCupCourseOrder[gCupSelection][gCourseIndexInCup]], 0, someScale,
                                  someScale);
        someScale = 0.8f;
        switch (arg0->state) {
            case 1:
            ...
            case 16:
                someScale = 0.8f;
                set_text_color(TEXT_RED);
                print_text1_center_mode_2(0x0000009D, 0x00000060, gBestTimeText[0], 0, someScale, someScale);
                temp_a0 = func_800B4E24(0);
                temp_a0 &= 0xFFFFF;
                get_time_record_minutes(temp_a0, sp84);
                text_draw(0x0000007F, 0x0000006D, sp84, 0, someScale, someScale);
                ...
                get_time_record_seconds(temp_a0, sp84);
                text_draw(0x00000098, 0x0000006D, sp84, 0, someScale, someScale);
                print_text_mode_2(0x000000A7, 0x0000006D, "\"", 0, someScale, someScale);
                get_time_record_centiseconds(temp_a0, sp84);
                text_draw(0x000000B3, 0x0000006D, sp84, 0, someScale, someScale);
                print_text1_center_mode_2(0x0000009D, 0x0000007C, gBestTimeText[1], 0, someScale, someScale);
                temp_a0 = func_800B4F2C();
                temp_a0 &= 0xFFFFF;
                get_time_record_minutes(temp_a0, sp84);
                text_draw(0x0000007F, 0x00000089, sp84, 0, someScale, someScale);
                ...
                get_time_record_seconds(temp_a0, sp84);
                text_draw(0x00000098, 0x00000089, sp84, 0, someScale, someScale);
                print_text_mode_2(0x000000A7, 0x00000089, "\"", 0, someScale, someScale);
                get_time_record_centiseconds(temp_a0, sp84);
                text_draw(0x000000B3, 0x00000089, sp84, 0, someScale, someScale);
                someScale = 0.75f;
                var_v0_9 = &D_800E8538[0];
                for (var_s1 = 0; var_s1 < 6; var_s1++) {
                    text_rainbow_effect(arg0->state - 0xB, var_s1, TEXT_GREEN);
                    print_text_mode_2(var_v0_9->column, var_v0_9->row + (0xD * var_s1),
                                      gTextPauseButton[var_s1 + 1], 0, someScale, someScale);
                }
                break;
            case 21:
            ...
            case 26:
                ...
                temp_v0 = arg0->state - 0x15;
                for (var_s1 = 0; var_s1 < 7; var_s1++) {
                    print_text_mode_1(0x0000004D, 0x6E + (0xD * var_s1), D_800E798C[(temp_v0 * 7) + var_s1], 0,
                                      someScale, someScale);
                }
                break;
            case 30:
            case 31:
                set_text_color(TEXT_GREEN);
                for (var_s1 = 0; var_s1 < 2; var_s1++) {
                    print_text_mode_1(0x0000005A, arg0->row + 0x6E + (0xD * var_s1), D_800E7A3C[var_s1], 0, someScale,
                                      someScale);
                }
                someScale = 0.75f;
                for (var_s1 = 0; var_s1 < 2; var_s1++) {
                    ...
                    highlight = 0;
                    if (ghost->ghostDataSaved != 0) {
                        ghostCourse = ghost->courseIndex;
                        if (((ghostCourse / 4) == gCupSelection) && ((ghostCourse % 4) == gCourseIndexInCup)) {
                            set_text_color(TEXT_BLUE);
                            highlight = 1;
                            gDPSetPrimColor(gDisplayListHead++, 0, 0, 0x00, 0x00, 0x00, 0x96);
                        }
                    ...
                    convert_number_to_ascii(var_s1 + 1, sp5C);
                    if (highlight != 0) {
                        print_text_mode_2(0x5A - arg0->column, (0x96 + (0x14 * var_s1)), &sp5C[1], 0, someScale,
                                          someScale);
                    } else {
                        print_text_mode_1(0x5A - arg0->column, (0x96 + (0x14 * var_s1)), &sp5C[1], 0, someScale,
                                          someScale);
                    }
                    if (D_8018EE10[var_s1].ghostDataSaved == 0) {
                        ghostNamePtr = &D_800E7A44;
                        if (highlight != 0) {
                            print_text_mode_2(0x70 - arg0->column, (0x96 + (0x14 * var_s1)), *ghostNamePtr, 0,
                                              someScale, someScale);
                        } else {
                            print_text_mode_1(0x70 - arg0->column, (0x96 + (0x14 * var_s1)), *ghostNamePtr, 0,
                                              someScale, someScale);
                        }
                    } else {
                        ghostCourse2 = D_8018EE10[var_s1].courseIndex;
                        if (highlight != 0) {
                            print_text_mode_2(0x70 - arg0->column, (0x96 + (0x14 * var_s1)),
                                              gCourseNamesDup2[gCupCourseOrder[ghostCourse2 / 4][ghostCourse2 % 4]], 0,
                                              someScale, someScale);
                        } else {
                            print_text_mode_1(0x70 - arg0->column, (0x96 + (0x14 * var_s1)),
                                              gCourseNamesDup2[gCupCourseOrder[ghostCourse2 / 4][ghostCourse2 % 4]], 0,
                                              someScale, someScale);
                        }
                    }
            ...
            case 36:
                set_text_color(TEXT_YELLOW);
                for (var_s1 = 0; var_s1 < 3; var_s1++) {
                    print_text_mode_1(0x00000055, arg0->row + 0x6E + (0xD * var_s1), D_800E7A60[var_s1], 0, someScale,
                                      someScale);
                }
                for (var_s1 = 0; var_s1 < 2; var_s1++) {
                    text_rainbow_effect(arg0->state - 0x23, var_s1, TEXT_GREEN);
                    print_text_mode_1(0x7D - arg0->column, 0x9B + (0xF * var_s1), D_800E7A6C[var_s1], 0, someScale,
                                      someScale);
                }
                break;
            case 40:
                set_text_color(TEXT_YELLOW);
                for (var_s1 = 0; var_s1 < 3; var_s1++) {
                    print_text_mode_1(0x00000055, (0xD * var_s1) + 0x6E, D_800E7A74[var_s1], 0, someScale, someScale);
                }
                break;
            case 41:
                set_text_color(TEXT_YELLOW);
                for (var_s1 = 0; var_s1 < 2; var_s1++) {
                    print_text_mode_1(0x0000005D, (0xD * var_s1) + 0x6E, D_800E7A80[var_s1], 0, someScale, someScale);
                }
                break;
        }
        switch (arg0->state) { /* switch 2 */
...
void func_800A6034(MenuItem* arg0) {
    ...
    char* text;
    s32 width;
    f64 someMultiplier = 0.65;

    if (D_801657E8 != true) {
        gDPSetPrimColor(gDisplayListHead++, 0, 0, 0x00, 0x00, 0x00, arg0->param1);
        text = gCupNames[D_800DC540];
        set_text_color(TEXT_BLUE_GREEN_RED_CYCLE_2);
        width = get_string_width(text);
        print_text_mode_2((arg0->column - (width / 2)) + 0x46, arg0->row + 0xA0, text, 0, 1.0f, 1.0f);
        divisor = 2.0;
        text = gCourseNames[gCurrentCourseId];
        set_text_color((s32) gCurrentCourseId % 4);
        width = get_string_width(text);
        print_text_mode_2((arg0->column + 0x46) - ((width * someMultiplier) / divisor), arg0->row + 0xC3, text, 0,
                          0.65f, 0.85f);
    }
}
#else
...
void func_800A6154(MenuItem* arg0) {
...
#ifdef VERSION_CN
        for (var_s1 = 0; var_s1 < 2; var_s1++) {
            print_text_mode_2(0x0000008C, (var_s1 * 0x14) + 0x96, gTextPauseButton[(var_s1 * 3) + 1], 0, sc, sc);
#else
...
#ifdef VERSION_CN
            print_text_mode_1(0x0000008C, (var_s1 * 0x14) + 0x96, gTextPauseButton[(var_s1 * 3) + 1], 0, sc, sc);
#else
    ...
    if (arg0->state >= 0xB) {
        sp6C.column = 0x0084;
#ifdef VERSION_CN
        sp6C.row = ((arg0->state - 0xB) * 0x14) + 0x8E;
#else
...
#ifdef VERSION_JP
            print_text_mode_1(0x00000082, 0xAE + (0xF * var_s1), gTextPauseButton[var_s1 + 1], 0, 0.8f, 0.8f); // Where Retry, course change, etc printed
#elif defined(VERSION_CN)
            print_text_mode_1(0x00000069, 0xAE + (0xF * var_s1), gTextPauseButton[var_s1 + 1], 0, sc, sc); // Where Retry, course change, etc printed
#else
...
#ifdef VERSION_JP
/* Keeps this file's bss ending at 0x8018b580, where code_800AF9B0's begins.
   Three scalars, not s32[3]: IDO 8-byte-aligns arrays, which would leave a
   4-byte hole in front of the pad and push the whole tail out. */
s32 menu_item_bss_padjp1;
s32 menu_item_bss_padjp2;
s32 menu_item_bss_padjp3;
#endif
...
#ifdef VERSION_JP
        print_text_mode_2(D_800E7380[var_s0].column, D_800E7380[var_s0].row, temp_s3, 0, 1.0f, 1.0f);
#else
...
void func_800A70E8(MenuItem* arg0) {
    ...
    if (arg0->state == 1) {
#ifdef VERSION_CN
        ptr = D_800E7A34;
        var_s0 = get_string_width(ptr[0]) * scale;
        temp_f6 = get_string_width(ptr[1]) * scale;
#else
#ifdef VERSION_JP
        var_s0 = get_string_width(D_800E7A34[0]) * 0.5f;
        temp_f6 = get_string_width(D_800E7A34[1]) * 0.5f;
#else
        ...
        set_text_color(TEXT_RED);
#ifdef VERSION_CN
        for (stringIndex = 0; stringIndex < 2; stringIndex++) {
            print_text_mode_2(0x000000C0, 0x2C + stringIndex * 0xA, ptr[stringIndex], 0, scale, scale);
#else
        for (loopIndex = 0x2C, stringIndex = 0; loopIndex < 0x40; loopIndex += 0xA, stringIndex++) {
#ifdef VERSION_JP
            print_text_mode_2(0x000000C3, loopIndex, D_800E7A34[stringIndex], 0, 0.5f, 0.5f);
#else
...
void func_800A75A0(MenuItem* arg0) {
    ...
    set_text_color(TEXT_BLUE_GREEN_RED_CYCLE_1);
#ifdef VERSION_CN
    print_text1_center_mode_1(arg0->column + 10, arg0->row, D_800E7A9C[topThree], 0, scale, scale);
#else
...
void func_800A761C(MenuItem* arg0) {
...
#ifdef VERSION_CN
    sp48 = ((get_string_width(gPlaceText[0]) + 5) * scale) / 2;
    sp44 = ((get_string_width(gPlaceText[temp_a0]) + 5) * scale) / 2;
#else
    ...
    set_text_color(TEXT_BLUE_GREEN_RED_CYCLE_2);
#ifdef VERSION_CN
    print_text1_center_mode_1((arg0->column - sp44) + 40, arg0->row, gPlaceText[0], 0, scale, scale);
#else
    print_text1_center_mode_1(arg0->column - sp44, arg0->row, gPlaceText[0], 0, 1.2f, 1.2f);
#endif
    set_text_color((s32) gGlobalTimer % 3);
#ifdef VERSION_CN
    print_text1_center_mode_1((arg0->column + sp48) + 40, arg0->row, gPlaceText[temp_a0], 0, scale, scale);
#else
...
#ifdef VERSION_CN
    scale = 2.0f;
    func_800939C8((arg0->column + sp48) + 10, arg0->row, &sp3C[1], 0, scale, scale);
#else
...
void menu_item_credits_render(MenuItem* arg0) {
    ...
    s32 creditIndex;
    char** textPtr;
    /* No slideDirection local: it would take the slot info's spill needs. IDO
       CSEs the two reads into the single lb the real ROM has. */
    CreditsRenderInfo* info;

    creditIndex = arg0->type - 0x190;
    info = &gCreditsTextRenderInfo[creditIndex];
    if (gCCSelection == CC_EXTRA) {
        textPtr = &gCreditsTextExtra[creditIndex];
    } else {
        textPtr = &gCreditsText[creditIndex];
    }
    set_text_color(info->textColor);
    if ((info->slideDirection == SLIDE_RIGHT) || (info->slideDirection != SLIDE_LEFT)) {
        someScaling = info->textScaling;
        print_text1_left(arg0->column, arg0->row, *textPtr, arg0->param1 * someScaling,
                         arg0->paramf * someScaling, someScaling);
    } else {
        someScaling = info->textScaling;
        print_text_mode_1(arg0->column, arg0->row, *textPtr, arg0->param1 * someScaling,
                          arg0->paramf * someScaling, someScaling);
    }
}
#else
...
#ifdef VERSION_CN
            s32 temp = sp34 - 0x1E;
            gDisplayListHead = draw_box_fill(gDisplayListHead, temp_t0 + sp34, temp_a2, temp_t0 - temp,
...
#ifdef VERSION_CN
    text_draw(arg0->column + 5, arg0->row + 0x21, buffer, 0, scX, scY);
    print_text_mode_1(arg0->column + 0xE, arg0->row + 0x21, "'", 0, scX, scY);
    get_time_record_seconds(temp_s1, buffer);
    text_draw(arg0->column + 0x16, arg0->row + 0x21, buffer, 0, scX, scY);
    print_text_mode_1(arg0->column + 0x20, arg0->row + 0x21, "\"", 0, scX, scY);
    get_time_record_centiseconds(temp_s1, buffer);
    text_draw(arg0->column + 0x29, arg0->row + 0x21, buffer, 0, scX, scY);
#else
...
#ifdef VERSION_CN
    print_text1_left(arg0->column + 0x66, arg0->row + 0x21, D_800E76A8[var_s2], 0, scX, scY);
#else
#ifdef VERSION_JP
    print_text1_left(arg0->column + 0x62, arg0->row + 0x21, D_800E76A8[var_s2], 0, 0.6f, 0.65f);
#else
...
#ifdef VERSION_CN
                s32 temp = temp_t7 - 64;
                gDisplayListHead = draw_box_fill(gDisplayListHead, temp_t1 + temp_t7, temp_a2, temp_t1 - temp,
...
void render_battle_introduction(UNUSED MenuItem* arg0) {
    set_text_color(TEXT_YELLOW);
    print_text1_center_mode_1(0xA0, 0x44, gTextBattleIntroduction[0], 0, 1.0f, 1.0f);
    print_text_mode_1(0x1A, 0x58, gTextBattleIntroduction[1], 0, 0.95f, 0.95f);
    func_800939C8(0x1E, 0x6A, gTextBattleIntroduction[2], 4, 0.95f, 0.95f);
}
#else
void render_battle_introduction(UNUSED MenuItem* arg0) {
#ifdef VERSION_CN
...
#ifdef VERSION_CN
                temp = arg0->param1 - 2;
                arg0->param1 = temp - (arg0->param1 / 12);
#else
...
void func_800A9C40(MenuItem* arg0) {
    switch (arg0->state) {
        case 0:
            func_800AA280(arg0);
#ifdef VERSION_CN
            if ((gPlayerCount - 1) == (arg0->type - MENU_ITEM_UI_1P_GAME)) {
#else
        ...
        case 1:
            func_800AA280(arg0);
#ifdef VERSION_CN
            if (gMainMenuSelection <= MAIN_MENU_MODE_SUB_SELECT_GO_BACK) {
                if (gMainMenuSelection >= MAIN_MENU_OK_SELECT_GO_BACK) {
                    arg0->param1 = 0x00000020;
                    break;
                }
...
#ifdef VERSION_CN
    if ((gPlayerCount - 1) == (arg0->type - 0xB)) {
#else
    if ((gPlayerCount + 0xA) == arg0->type) {
#endif
        arg0->priority = 0x0A;
...
#ifdef VERSION_CN
                        sp18 = (gGameModeMenuColumn[gPlayerCount - 1] * 0x12) + 0x41;
                        arg0->row = temp_v0->row + sp18;
#else
...
#ifdef VERSION_CN
                        arg0->row = temp_v0->row + temp_v1_2->row + (gGameModeMenuColumn[gPlayerCount - 1] * 0x12);
#else
...
#ifdef VERSION_CN
                        if (gGameModeMenuColumn[gPlayerCount - 1] != arg0->param2) {
                            arg0->state = 0;
                        }
                        temp_v0 = get_menu_item_player_count();
                ...
                case MAIN_MENU_MODE_SUB_SELECT_GO_BACK: /* switch 4 */
                    if ((temp_a1 != sp20) && (temp_a1 != sp1C)) {
                        ...
                        func_800A91D8(arg0, arg0->column,
                                      temp_v0->row + temp_v1_2->row + (gGameModeMenuColumn[gPlayerCount - 1] * 0x12));
#else
                        func_800A91D8(arg0, arg0->column,
...
void func_800AAC18(MenuItem* arg0) {
    ...
    switch (arg0->state) {
        ...
        case 3:
#ifdef VERSION_CN
            arg0->column = (s32) D_800E7108[0][temp_a1].column;
            arg0->row = (s32) D_800E7108[0][temp_a1].row;
#else
...
void func_800AB098(MenuItem* arg0) {
    switch (arg0->state) {
        case 0:
#ifdef VERSION_CN
            if (gCupSelection == (arg0->type - 0x53)) {
#else
...
void func_800AF480(MenuItem* arg0) {
    ...
    if (gCreditsTextRenderInfo[idx].slideDirection == 0) {
        func_800AF4DC(arg0);
    } else if (gCreditsTextRenderInfo[idx].slideDirection != 1) {
#else
...
#ifdef VERSION_JP
    if (gCCSelection == CC_EXTRA) {
        textPtr = &gCreditsTextExtra[temp_v0];
    } else {
        textPtr = &gCreditsText[temp_v0];
    }
#endif
